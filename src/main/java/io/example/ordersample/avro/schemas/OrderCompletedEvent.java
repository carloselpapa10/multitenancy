...
public class OrderCompletedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5553010229915926493L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderCompletedEvent\",\"namespace\":\"io.example.ordersample.avro.schemas\",\"fields\":[{\"name\":\"id\",\"type\":\"string\",\"doc\":\"Id of Order\"}],\"version\":\"1\"}");
   ...
   */
  public OrderCompletedEvent(java.lang.CharSequence id) {
    this.id = id;
  }
   ...
   */
  public static io.example.ordersample.avro.schemas.OrderCompletedEvent.Builder newBuilder() {
    return new io.example.ordersample.avro.schemas.OrderCompletedEvent.Builder();
  }
   ...
   * @return A new OrderCompletedEvent RecordBuilder
   */
  public static io.example.ordersample.avro.schemas.OrderCompletedEvent.Builder newBuilder(io.example.ordersample.avro.schemas.OrderCompletedEvent.Builder other) {
    return new io.example.ordersample.avro.schemas.OrderCompletedEvent.Builder(other);
  }
   ...
   * @return A new OrderCompletedEvent RecordBuilder
   */
  public static io.example.ordersample.avro.schemas.OrderCompletedEvent.Builder newBuilder(io.example.ordersample.avro.schemas.OrderCompletedEvent other) {
    return new io.example.ordersample.avro.schemas.OrderCompletedEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderCompletedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.example.ordersample.avro.schemas.OrderCompletedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.example.ordersample.avro.schemas.OrderCompletedEvent other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.example.ordersample.avro.schemas.OrderCompletedEvent.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.example.ordersample.avro.schemas.OrderCompletedEvent.Builder clearId() {
      id = null;
